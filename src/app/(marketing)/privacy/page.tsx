  ...
  return (
    <article className="max-w-3xl">
      ...
      <div className="mt-10 prose-custom text-muted-foreground space-y-6">
        ...
        <section>
          <h2 className="text-xl font-semibold text-foreground">Information we may collect</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-foreground">Rights (EEA / UK and similar regions)</h2>
          <p>
